...
const { 
        createFee, getFees, payFee, generateInvoice, 
        sendReminder, initiatePayment, handlePaymentCallback, 
        getParentFeesStatus, generatePaymentSlip,
        createClassFee, modifyClassFee, modifyStudentFee, 
        getStudentFeeHistory, getParentFeeHistory 
...
router.post('/class', protect, authorize('collegeadmin','superadmin'), featureAuthorize('feeManagement'), createClassFee); // create class fees
router.patch('/class', protect, authorize('collegeadmin','superadmin'), featureAuthorize('feeManagement'), modifyClassFee); // modify class fees (bulk)
router.get('/parent-history', protect, authorize('parent'), featureAuthorize('feeManagement'), getParentFeeHistory); // get all students' histories for parent
router.patch('/student/:feeId', protect, authorize('collegeadmin','superadmin'), featureAuthorize('feeManagement'), modifyStudentFee); // modify specific fee
router.get('/student-history/:studentId', protect, authorize('collegeadmin','superadmin','parent'), featureAuthorize('feeManagement'), getStudentFeeHistory); // get student fee history (parent can use if student's parent)
